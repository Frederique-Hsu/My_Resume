...
\begin{document}
    ...
    \cvdetail{
        ...
        I had helped to design a hierarchical, message-passing based, and easy-to-horizontal-scale dynamically software architecture, according
        ...
        \begin{center}
            ...
            \end{tabular}
        \end{center}
        Comparing with the benchmark Siemens D-Cubed engine in CAD industry, this engine has offered as rich features as 175+ interfaces, plus the 
    ...
    \cvdetail{
        ...
        Additionally, took charge of the automatic CI building and Regression Test Pipeline, push the agile development with the optimized workflow: 
    ...
    \cvdetail{
        ...
        This patent takes good use of OpenCL parallel heterogeneous computing framework for the 1st time, utilizing such computing resources as GPU. FPGA
        and DSP to accelerate the super-large-scale Jacobian matrix decomposition for geometry constraint solving system. Applying this patent had dramatically
    ...
    \engcvsubsection{Mar. 2022 - Feb. 2023}{C++ developer}{BMW (Shanghai) Autonomous Driving Lab.}
    ...
    \cvdetail{
        ...
        We have implemented the Road Model using C++ and Python on Ubuntu Linux platform, auto-built the software with Bazel build system, wrote many test 
